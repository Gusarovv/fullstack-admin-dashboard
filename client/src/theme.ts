import { Theme } from './store/reducers/GlobalSlice';

type StandardColorTokens = {
    100: string;
    200: string;
    300: string;
    400: string;
...
type GreyColorTokens = {
    0: string;
    10: string;
    50: string;
    1000: string;
} & StandardColorTokens;
type PrimaryColorTokens = StandardColorTokens;
type SecondaryColorTokens = { 50: string } & StandardColorTokens;
...
/** mui theme settings */
export const themeSettings = (mode: Theme): ThemeSettings => {
    return {
        palette: {
            mode: mode,
            ...(mode === 'dark'
